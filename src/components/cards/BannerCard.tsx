...
function BannerCard({ item }: BannerCardProps) {
  ...
  return (
    ...
    >
      ...
      <div>
        <p
          className={`${subTitleColor} mb-[20px] leading-[1.786] dark:text-white/60`}
        >
          {content}
        </p>
      </div>
      <div className="flex flex-wrap items-center justify-between">
        <div className="flex items-center gap-[15px]">
          ...
          />
          <span
            className={`${subTitleColor} text-[15px] font-medium dark:text-white/60`}
          >
            {authorName}
          </span>
        </div>
        <div>
          <ul className="flex items-center flex-wrap gap-[10px] mb-0">
            <li className="flex items-center gap-[6px]">
              ...
              <span className="text-light-extra dark:text-white/60 text-[13px]">
                70
              </span>
            </li>
            <li className="flex items-center gap-[6px]">
