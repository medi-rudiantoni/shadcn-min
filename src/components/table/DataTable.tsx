...
import {
  dataLiveFilter,
  filterWithSubmit,
} from "@/redux/data-filter/actionCreator";
...
function DataTable({
  ...
  const prefix = (
    <UilSearch className="w-4 h-4 ltr:mr-2 rtl:ml-2 text-light dark:text-white/60" />
  );
  return (
    <>
      {filterOption ? (
          ...
          {!filterOnchange ? (
            <div className="inline-flex items-center flex-wrap w-full gap-[20px] md:justify-center">
              <div className="inline-flex items-center">
                <span className="ltr:mr-2 rtl:ml-2 dark:text-white/60">
                  Id:
                </span>
                <Input
