...
import { createContract, getContractByNumber } from "@/functions/contract";
...
function AddContract() {
  ...
  const onSubmit = () => {
    createContract(data, token).then((res) => {
      setSubmit(true);
      //console.log("res", res);
      if (res.data.success) {
                    ...
                    <Col md={8} xs={24}>
                      ...
                      >
                        <InputNumber<number>
                          ...
                          parser={(val) =>
                            val?.replace(/\$\s?|(,*)/g, "") as unknown as number
                          }
                          max={1000000000}
                    ...
                    <Col md={8} xs={24}>
                      ...
                      >
                        <Input
                          ...
                          type="number"
                          onChange={(e) =>
                            setData({ ...data, slaResponTime: e.target.value })
                          }
                        />
                      </Form.Item>
                    </Col>
